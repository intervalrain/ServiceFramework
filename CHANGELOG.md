...
## [1.3.0] - 2025-08-01
### 新增功能
- **MessageFramework**: - **MessageFramework**: Added RequestDto and ResponseDto, and automatically add audit wrapper via setting  EnableAuditWrapper
- **Audit Log**: Added standard requeust & respone auditi log.

## [1.2.2] - 2025-07-17
### Enhanced
- **AddNatsCheck**: Provide concise HealthCheck interface which is an extension of HealthCheckBuilder.
### Fixed
- Fixed multi-connection problem.
- Fixed NatsConnectionHealthCheck problem.
