...
public class BookServiceAppHandler : ServiceHandler
{
    private readonly IBookAppService _bookAppService;

    public override string ServiceName => "bookstoreApp";
    public override string ServiceVersion => "1.0.0";
    public override string QueueGroup => "bookstore-queue2";
    private readonly JsonSerializerOptions _jsonOptions;

    public BookServiceAppHandler(
    ...
    [Subject("getBook2", "bookstore2.books.*.get")]
    ...
    [Subject("getBooks2", "bookstore2.books.get")]
    ...
    [Subject("createBook2", "bookstore2.books.post")]
    ...
    [Subject("updateBook2", "bookstore2.books.*.put")]
    ...
    [Subject("deleteBook2", "bookstore2.books.*.delete")]
